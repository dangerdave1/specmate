...
@Component({
    ...
    selector: '[connection-line-dashed]',
    templateUrl: 'connection-line-dashed.component.svg',
    styleUrls: ['connection-line-dashed.component.css']
})
export class ConnectionLineDashed {
    @Input()
